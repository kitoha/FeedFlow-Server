...
import com.feedflow.api.request.PresignedUrlRequest
...
class StorageController(
  ...
  @PostMapping("/v1/storage/presigned-upload-url")
  fun generateUploadPresignedUrl(
    @RequestBody request: PresignedUrlRequest
  ): ResponseEntity<PresignedResponse> {
    val response = fileService.generatePreSignUrl(request.toCommand())
